...
#include "../strategies/TextRestricter.h"
...
TEST(TextRestricterTest, NoRestriction) {
    TextRestricter restricter(std::make_unique<NoRestrictionStrategy>());
...
TEST(TextRestricterTest, CurseRestriction) {
    TextRestricter restricter(std::make_unique<CurseRestrictionStrategy>());
    std::string concatedText;
...
TEST(TextRestricterTest, LengthRestriction) {
    TextRestricter restricter(std::make_unique<LengthRestrictionStrategy>(1, 10));
    std::string concatedText;
